...
/**
 * Created by gjy on 2016/1/12.
 */
@Controller
public class fileController {
    @RequestMapping(value = "/fileUpload", method = {RequestMethod.POST, RequestMethod.GET})
    @ResponseBody
    public JSONObject fileUpload(HttpServletRequest request) throws FileUploadException {
    ...
    @RequestMapping(value = "/fileManage",method = {RequestMethod.GET,RequestMethod.POST})
    @ResponseBody
    public JSONObject fileManage(HttpServletRequest request) {
